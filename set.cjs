...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~DvYkXZ5A#iGFJZjk1knwW6DNb_8YlL3x1CC8kMl4kd3lkOv5nLKQ",
  ...
  AUTOLIKE_STATUS: process.env.AUTOLIKE_STATUS !== undefined ? process.env.AUTOLIKE_STATUS === 'falae' : false,
